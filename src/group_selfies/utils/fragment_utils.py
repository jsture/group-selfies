from group_selfies.utils.group_utils import (
    hash_molecule,
    HashableMolecule,
    mol_to_group_s,
    bond_to_order,
...
from rdkit.Chem.Fraggle import FraggleSim  # type: ignore
from rdkit.DataManip.Metric import rdMetricMatrixCalc  # type: ignore
import math
...
def select_diverse_set(l, k, weights=None):  # type: ignore
    if weights is None:
        weights = [1] * len(l)
